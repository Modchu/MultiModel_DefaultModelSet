...
import modchu.model.ModchuModel_ModelBox;
...
public class ModchuModel_ModelRendererBase {
	...
	public List<ModchuModel_ModelBoxBaseBase> cubeList;
	public List<ModchuModel_ModelRendererBase> childModels;
	public final String boxName;
	protected ModchuModel_ModelBase baseModel;
...
//	public static final int ModeParts = 0x010;
	...
	public ModchuModel_ModelRendererBase(ModchuModel_ModelBase pModelBase, String pName) {
		textureWidth = 64.0F;
		textureHeight = 32.0F;
		compiled = false;
		displayList = 0;
		...
		isHidden = false;
		isRendering = true;
		cubeList = new ArrayList<ModchuModel_ModelBoxBaseBase>();
	...
	public ModchuModel_ModelRendererBase(ModchuModel_ModelBase pModelBase, int px, int py) {
		this(pModelBase, null);
		setTextureOffset(px, py);
	}

	public ModchuModel_ModelRendererBase(ModchuModel_ModelBase pModelBase) {
		this(pModelBase, (String)null);
	}

	public ModchuModel_ModelRendererBase(ModchuModel_ModelBase pModelBase, int px, int py, float pScaleX, float pScaleY, float pScaleZ) {
	...
	public ModchuModel_ModelRendererBase(ModchuModel_ModelBase pModelBase, float pScaleX, float pScaleY, float pScaleZ) {
		this(pModelBase);
		this.scaleX = pScaleX;
		this.scaleY = pScaleY;
		this.scaleZ = pScaleZ;
	...
	public void addChild(ModchuModel_ModelRendererBase pModelRenderer) {
		if (childModels == null) {
			childModels = new ArrayList<ModchuModel_ModelRendererBase>();
		}
	...
	public ModchuModel_ModelRendererBase addBox(String pName, float pX, float pY, float pZ,
			int pWidth, int pHeight, int pDepth) {
		addParts(ModchuModel_ModelBox.class, pName, pX, pY, pZ, pWidth, pHeight, pDepth, 0.0F);
		return this;
	}

	public ModchuModel_ModelRendererBase addBox(float pX, float pY, float pZ,
			int pWidth, int pHeight, int pDepth) {
		addParts(ModchuModel_ModelBox.class, pX, pY, pZ, pWidth, pHeight, pDepth, 0.0F);
		return this;
	}

	public ModchuModel_ModelRendererBase addBox(float pX, float pY, float pZ,
			int pWidth, int pHeight, int pDepth, float pSizeAdjust) {
		addParts(ModchuModel_ModelBox.class, pX, pY, pZ, pWidth, pHeight, pDepth, pSizeAdjust);
		return this;
	}

	public ModchuModel_ModelRendererBase setRotationPoint(float pX, float pY, float pZ) {
		rotationPointX = pX;
		rotationPointY = pY;
		rotationPointZ = pZ;
		return this;
	...
	protected void compileDisplayList(float par1) {
		...
		for (int i = 0; i < cubeList.size(); i++) {
			((ModchuModel_ModelBoxBaseBase) cubeList.get(i)).render(tessellator, par1);
		}
	...
	public ModchuModel_ModelRendererBase setTextureSize(int pWidth, int pHeight) {
	 ...
	 */
	public ModchuModel_ModelRendererBase addCubeList(ModchuModel_ModelBoxBaseBase object) {
		cubeList.add(object);
		return this;
	}

	protected ModchuModel_ModelBoxBaseBase getModelBoxBase(Class pModelBoxBase, Object ... pArg) {
		try {
			Constructor<ModchuModel_ModelBox> lconstructor =
					pModelBoxBase.getConstructor(ModchuModel_ModelRendererReplacePoint.class, Object[].class);
	...
	public ModchuModel_ModelRendererBase addParts(Class pModelBoxBase, String pName, Object ... pArg) {
		...
		addCubeList(((ModchuModel_ModelBoxBaseBase) getModelBoxBase(pModelBoxBase, getArg(pArg))).setBoxName(pName));
		return this;
	}

	public ModchuModel_ModelRendererBase addParts(Class pModelBoxBase, Object ... pArg) {
	 ...
	 * コンストラクタへそのまま値を渡します。
	 */
	public ModchuModel_ModelRendererBase addPartsTexture(Class pModelBoxBase, String pName, Object ... pArg) {
		pName = (new StringBuilder()).append(boxName).append(".").append(pName).toString();
		addCubeList(((ModchuModel_ModelBox) getModelBoxBase(pModelBoxBase, pArg)).setBoxName(pName));
		return this;
	}
	 ...
	 * コンストラクタへそのまま値を渡します。
	 */
	public ModchuModel_ModelRendererBase addPartsTexture(Class pModelBoxBase, Object ... pArg) {
		addCubeList(getModelBoxBase(pModelBoxBase, pArg));
		return this;
	}


	public ModchuModel_ModelRendererBase addPlate(float pX, float pY, float pZ,
	...
	public ModchuModel_ModelRendererBase addPlate(String pName, float pX, float pY, float pZ,
			int pWidth, int pHeight, int pFacePlane) {
	...
	// TODO:このあたりは要修正
	public boolean renderItems(ModchuModel_ModelMultiBase pModelMulti, ModchuModel_IModelCaps pEntityCaps, boolean pRealBlock, int pIndex) {
	...
	public void renderItemsHead(ModchuModel_ModelMultiBase pModelMulti, ModchuModel_IModelCaps pEntityCaps) {
...
//			pRender.loadTexture("/gui/items.png");
	...
	public ModchuModel_ModelRendererBase setMirror(boolean flag) {
		mirror = flag;
		return this;
	}
	...
	public ModchuModel_ModelRendererBase setRotateAngle(float x, float y, float z) {
		rotateAngleX = x;
		rotateAngleY = y;
		rotateAngleZ = z;
		return this;
	...
	public ModchuModel_ModelRendererBase setRotateAngleDeg(float x, float y, float z) {
	...
	public ModchuModel_ModelRendererBase setScale(float pX, float pY, float pZ) {
		scaleX = pX;
		scaleY = pY;
		scaleZ = pZ;
		return this;
