...
public class ModchuModel_ClientReplacePointBase {
...
*/
	...
	public static void renderArrowsStuckInEntity(EntityLivingBase par1EntityLiving, float par2,
			Render pRender, ModchuModel_ModelBase pModel) {
		...
		if (lacount > 0) {
			...
			for (int var6 = 0; var6 < lacount; ++var6) {
				...
				ModchuModel_ModelRenderer var7 = pModel.getRandomModelBox(lrand);
				ModchuModel_ModelBoxBaseBase var8 = (ModchuModel_ModelBoxBaseBase) var7.cubeList.get(lrand.nextInt(var7.cubeList.size()));
