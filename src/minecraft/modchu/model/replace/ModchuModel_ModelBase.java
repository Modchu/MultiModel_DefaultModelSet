...
public abstract class ModchuModel_ModelBase {
	...
	public List<ModchuModel_ModelRendererBase> boxList = new ArrayList();
	...
	public ModchuModel_ModelRenderer getRandomModelBox(Random par1Random) {
		// 膝に矢を受けてしまってな・・・
		int li = par1Random.nextInt(this.boxList.size());
		ModchuModel_ModelRenderer lmr = (ModchuModel_ModelRenderer)this.boxList.get(li);
		for (int lj = 0; lj < boxList.size(); lj++) {
			...
			lmr = (ModchuModel_ModelRenderer)this.boxList.get(li);
		}
		return lmr;
	}
