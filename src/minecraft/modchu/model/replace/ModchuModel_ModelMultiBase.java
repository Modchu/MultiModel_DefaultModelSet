 ...
 */
public abstract class ModchuModel_ModelMultiBase extends ModchuModel_ModelBase implements ModchuModel_IModelCapsReplacePoint {
	...
	public ModchuModel_ModelMultiBase() {
		this(0.0F);
	}

	public ModchuModel_ModelMultiBase(float pSizeAdjust) {
		this(pSizeAdjust, 0.0F, 64, 32);
	}

	public ModchuModel_ModelMultiBase(float pSizeAdjust, float pYOffset, int pTextureWidth, int pTextureHeight) {
		isSneak = false;
		aimedBow = false;
		...
		if (ModchuModel_HelperReplacePoint.isClient) {
			...
			HeadMount = new ModchuModel_ModelRenderer((ModchuModel_ModelMultiReplacePoint) this, "HeadMount");
			HeadTop = new ModchuModel_ModelRenderer((ModchuModel_ModelMultiReplacePoint) this, "HeadTop");
