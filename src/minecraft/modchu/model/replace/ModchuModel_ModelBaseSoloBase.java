...
public class ModchuModel_ModelBaseSoloBase extends ModchuModel_ModelBaseNihilReplacePoint implements ModchuModel_IModelBaseModchuModelV160 {

	public ModchuModel_ModelMultiReplacePoint model;
	public ResourceLocation[] textures;
	public static final ResourceLocation[] blanks = new ResourceLocation[0];


	public ModchuModel_ModelBaseSoloBase(RendererLivingEntity pRender) {
