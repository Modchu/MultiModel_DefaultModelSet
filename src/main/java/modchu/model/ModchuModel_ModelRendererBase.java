...
public class ModchuModel_ModelRendererBase {
	...
	public ModchuModel_ModelRendererBase(Object pModelBase) {
		this(pModelBase, 0, 0, (String)null, 1.0F, 1.0F, 1.0F);
	}

	public ModchuModel_ModelRendererBase(Object modelBase, int px, int py) {
		this(modelBase, px, py, (String)null, 1.0F, 1.0F, 1.0F);
	}

	public ModchuModel_ModelRendererBase(Object modelBase, int px, int py, String s) {
		this(modelBase, px, py, s, 1.0F, 1.0F, 1.0F);
	}

	public ModchuModel_ModelRendererBase(Object pModelBase, int px, int py, float pScaleX, float pScaleY, float pScaleZ) {
		this(pModelBase, px, py, null, pScaleX, pScaleY, pScaleZ);
	}

	public ModchuModel_ModelRendererBase(Object pModelBase, String s) {
		this(pModelBase, 0, 0, s, 1.0F, 1.0F, 1.0F);
	}

	public ModchuModel_ModelRendererBase(Object pModelBase, float pScaleX, float pScaleY, float pScaleZ) {
		this(pModelBase, 0, 0, null, pScaleX, pScaleY, pScaleZ);
	}

	public ModchuModel_ModelRendererBase(Object pModelBase, int px, int py, String pName, float pScaleX, float pScaleY, float pScaleZ) {
		textureWidth = 64.0F;
		textureHeight = 32.0F;
		compiled = false;
		displayList = 0;
	...
	public void addChild(ModchuModel_ModelRendererBase modelRenderer) {
	...
	public ModchuModel_ModelRendererBase addBox(String pName, float pX, float pY, float pZ, int pWidth, int pHeight, int pDepth) {
		addParts(Modchu_ModelBoxMaster.class, pName, pX, pY, pZ, pWidth, pHeight, pDepth, 0.0F);
		return this;
	}

	public ModchuModel_ModelRendererBase addBox(float pX, float pY, float pZ, int pWidth, int pHeight, int pDepth) {
		addBox(pX, pY, pZ, pWidth, pHeight, pDepth, 0.0F);
		return this;
	}

	public ModchuModel_ModelRendererBase addBox(float pX, float pY, float pZ, int pWidth, int pHeight, int pDepth, float pSizeAdjust) {
		addBox(pX, pY, pZ, pWidth, pHeight, pDepth, pSizeAdjust, false);
		return this;
	}

	public ModchuModel_ModelRendererBase addBox(float pX, float pY, float pZ, int pWidth, int pHeight, int pDepth, float pSizeAdjust, boolean b) {
		addParts(Modchu_ModelBoxMaster.class, pX, pY, pZ, pWidth, pHeight, pDepth, pSizeAdjust, b);
		return this;
	}

	public ModchuModel_ModelRendererBase addParts(Class pModelBoxBaseMaster, String pName, Object... pArg) {
