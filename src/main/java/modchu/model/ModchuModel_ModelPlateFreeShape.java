...
public class ModchuModel_ModelPlateFreeShape extends Modchu_ModelBoxMasterBasis {
	...
	public ModchuModel_ModelPlateFreeShape(HashMap<String, Object> map) {
	...
	private ModchuModel_ModelPlateFreeShape(HashMap<String, Object> map, Object var1, int var2, int var3,
			float[][] var4, float[][] var5, float[][] var6, float[] var7, float var8) {
		super(map);
		ModchuModel_ModelRenderer modelRenderer = (ModchuModel_ModelRenderer) Modchu_Main.getModchuCharacteristicObjectMaster(var1);
		...
		triList[0] = new Modchu_TexturedQuad(Modchu_Main.getNewModchuCharacteristicMap(ModchuModel_TexturedTriangleMaster.class, positionTextureVertex, var5, vn, var7, 0.0F, 0.0F));
