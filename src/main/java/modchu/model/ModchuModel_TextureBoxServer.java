...
public class ModchuModel_TextureBoxServer extends ModchuModel_TextureBoxBase {

	// ローカルでモデルを保持している時にリンク
	public ModchuModel_TextureBoxBase localBox;


	public ModchuModel_TextureBoxServer() {
	}

	public ModchuModel_TextureBoxServer(ModchuModel_TextureBoxBase pBox) {
		localBox		= pBox;
