package modchu.model.multimodel;import modchu.lib.Modchu_EntityCapsHelper;import modchu.lib.Modchu_ModelPlateMaster;import modchu.model.ModchuModel_IEntityCaps;import modchu.model.ModchuModel_ModelRenderer;import modchu.model.multimodel.base.MultiModel_SR2;public class MultiModel_MS1 extends MultiModel_SR2 {
	public ModchuModel_ModelRenderer Goggles1;
	public ModchuModel_ModelRenderer Goggles2;
	public ModchuModel_ModelRenderer Goggles3;
	public ModchuModel_ModelRenderer GogglesR;
	public ModchuModel_ModelRenderer GogglesL;
	public ModchuModel_ModelRenderer Goggles1A;
	public ModchuModel_ModelRenderer Goggles2A;
	public ModchuModel_ModelRenderer Goggles3A;
	public ModchuModel_ModelRenderer GogglesRA;
	public ModchuModel_ModelRenderer GogglesLA;
	...
	public void initModel(float f, float f1, boolean isAfterInit) {
		...
		eyeR = new ModchuModel_ModelRenderer(this, 0, 0);
		eyeR.addPlate(-4F, -5.0F, -4.001F, 4, 4, 0, f);
		eyeR.setRotationPoint(0.0F, 0.0F, 0.0F);
		eyeL = new ModchuModel_ModelRenderer(this, 4, 0);
	...
	public void skirtFloatsInit(float f, float f1) {
		...
		SkirtTop.addPlate(0.0F, 0.0F, 0.0F, 7, 6, Modchu_ModelPlateMaster.planeXZTop);
		SkirtTop.setRotationPoint(-3.5F, -2.0F, -3.0F);		//ふんわりスカート前
		SkirtFront = new ModchuModel_ModelRenderer(this, 6, 22);
		SkirtFront.addPlate(0.0F, 0.0F, 0.0F, 7, 7, Modchu_ModelPlateMaster.planeXYFront);
		SkirtFront.setRotationPoint(0.0F, 0.0F, 0.0F);		//ふんわりスカート右
		SkirtRight = new ModchuModel_ModelRenderer(this, 0, 22);
		SkirtRight.addPlate(0.0F, 0.0F, 0.0F, 6, 7, Modchu_ModelPlateMaster.planeZYRight);
		SkirtRight.setRotationPoint(7.0F, 0.0F, 0.0F);		//ふんわりスカート左
		SkirtLeft = new ModchuModel_ModelRenderer(this, 13, 22);
		SkirtLeft.addPlate(0.0F, 0.0F, 0.0F, 6, 7, Modchu_ModelPlateMaster.planeZYLeft);
		SkirtLeft.setRotationPoint(0.0F, 0.0F, 0.0F);		//ふんわりスカート後ろ
		SkirtBack = new ModchuModel_ModelRenderer(this, 18, 22);
		SkirtBack.addPlate(0.0F, 0.0F, 0.0F, 7, 7, Modchu_ModelPlateMaster.planeXYBack);
