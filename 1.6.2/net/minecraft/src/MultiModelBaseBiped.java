...
*///151delete
	...
	public void renderItemsLM(MMM_IModelCaps entityCaps) {
		...
		if (Modchu_ModelCapsHelper.getCapsValueBoolean(entityCaps, caps_isCamouflage) || lplanter
			...
			if (inventory != null) {
				EntityLivingBase pEntity = (EntityLivingBase)entityCaps.getCapsValue(caps_Entity);
				int slot = (EntityLivingBase)pEntity instanceof EntityPlayer ? 10 : 16;
...
/*
		// 手持ちの表示
		EntityLivingBase pEntity = (EntityLivingBase) getCapsValue(entityCaps, entityCaps.caps_Entity);
		GL11.glPushMatrix();
		boolean lflag = true;
		if (entityCaps != null) {
